...
Reference_of_Cp=['Soldera','Schawe','Sasabe','Pyda','Chang']	#It is just to name final plots. This line plays NO role in code. 
...
for k in range(0,len(Program_Running_For)):
	...
	plt.plot(T0,C_total_myTheory,color='b',lw=linewidth,ls='-',label='Present Theory')
	plt.plot(T0,C_total_condoTheory,color='r',lw=linewidth,ls='--',label='Condo et al.')

	plt.plot(T0_above_Tg,C0_above_Tg,'sk',color='g',ms=markersize,label='Experiment')
