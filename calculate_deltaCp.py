...
Program_Running_For=['PVME Casalini 60kilo']		#189kilo_POST_THESIS
...
plt.plot(T0_below,C_total_below,color='r',lw=linewidth,ls='-',label='C_Total')
plt.plot(T0_below,C_kier_below,color='b',lw=linewidth,ls='--',label='C_Kier theory')
plt.plot(T0_below,C_line_below,color='c',lw=linewidth,ls=':',label='C_A+BT theory')

plt.plot(T0_above,C_total_above,color='r',lw=linewidth,ls='-',label='C_Total')
plt.plot(T0_above,C_kier_above,color='b',lw=linewidth,ls='--',label='C_Kier theory')
plt.plot(T0_above,C_line_above,color='c',lw=linewidth,ls=':',label='C_A+BT theory')

plt.plot(T0_complete_Tg,C0_complete_Tg,'sk',ms=markersize)#,label='36kilo experiment')
# plt.plot(T0_below_Tg,C0_below_Tg,'sk',ms=markersize)#,label='36kilo experiment')
